...
import { Difficulty, QuizSettingsType, QuizSettingsProps } from "@/types";
import { QUESTION_AMOUNTS, CATEGORIES } from "@/constants/trivia/constants";
import "@/components/triviaQuiz/QuizSettings.css";
